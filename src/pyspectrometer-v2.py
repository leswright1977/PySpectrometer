...
class App:
	def __init__(self, window, window_title, video_source=0):
		...
		self.canvas1.grid(row=0, column=0, padx=0, pady=0, columnspan=7)

		#peaks label
		self.lbpeak = tkinter.Label(self.bottom_frame  ,text = "Width:")
		...
		#threshold label
		self.lbthresh = tkinter.Label(self.bottom_frame  ,text = "Thresh:")
		...
		self.filt.grid(row=1, column=5, padx=0, pady=0, sticky="n")
		self.filt.set(7)	

		#Snapshot the graph
		self.snapshotbtn = tkinter.Button(self.bottom_frame, text="Snapshot", width=10, command=snapshot)
		self.snapshotbtn.grid(row=1, column=6, padx=0, pady=0)	
...
class MyVideoCapture:
	def __init__(self, video_source=0):
		...
		self.savpoly = 7 #savgole filter polynomial
	...
	def get_graph(self):
		...
		if self.vid.isOpened():
			...
			if ret:
				...
				intensity = savgol_filter(intensity,17,int(self.savpoly))
